        ...
        <div class="footer-wrap">
            ...
            <div class="pc">
                <ul class="depth1">
                    ...
                    <li><a href="" target="_blank">IKEA 서비스</a>
                        <div>
                            <ul>
                    ...
                    <li><a href="" target="_blank">IKEA 이야기</a>
                        <div>
                            <ul>
                    ...
                    <li><a href="" target="_blank">IKEA 그룹에서 일하기</a>
                        <div>
                            <ul>
                                <li><a href="">채용정보</a></li> 
                            </ul>
            ...
            <div class="mobile">
                <div class="drop_foot">
                    <dropdown class="mobile_hide">
                        <template slot="btn">쇼핑하기</template>
                        <template slot="body">
                            <ul>
                    ...
                    <dropdown class="mobile_hide">
                        <template slot="btn">IKEA 서비스</template>
                        <template slot="body">
                            <ul>
                                <li><a href="">배송 서비스</a></li>
                                <li><a href="">조립 서비스</a></li>
                    ...
                    <dropdown class="mobile_hide">
                        <template slot="btn">IKEA 이야기</template>
                        <template slot="body">
                            <ul>
                                <li><a href="">IKEA 컨셉</a></li>
                                <li><a href="">모두를 위한 디자인</a></li>
                    ...
                    <dropdown class="mobile_hide">
                        <template slot="btn">IKEA 그룹에서 일하기</template>
                        <template slot="body">
                            <ul>
                                <li><a href="">채용정보</a></li> 
                            </ul>
                    ...
                    <dropdown class="mobile_hide">
                        <template slot="btn">뉴스룸</template>
                        <template slot="body">
                            <ul>
                                <li><a href="">기업뉴스</a></li>
                                <li><a href="">제품뉴스</a></li>
            ...
            <div class="copy-write">
                <span>IKEA 코리아</span>
                <span>주소 : (우) 14352 경기도 광명시 일직로 17 IKEA광명점</span>
                <span>사업자 등록번호 : 106-86-82871</span>
                <span> 대표자 : 프레드리크 요한손</span>
                <span>통신판매업 신고 : 2018-경기광명-0209</span>
                <span>TEL : 1670-4532</span>
                <span>© Inter IKEA Systems B.V. 1999 - 2020</span>
            </div>
        </div> 
    </div>
</template>
